  ...
  return (
    <>
      <div className="MobileExperienceStyle">
        ...
        <CardMobile title="Google Cloud Facilitator" date="· Sept. 2020​ to Nov. 2020​​" text={[`Got trained under Developer Student Clubs(Powered by Google Developers) and Qwiklabs.`,`Organized 5+ Cloud workshops and gave hands-on with Google Cloud Platform.`]} src={require("/home/himandri/Dev/reactfol/himandrisharma.github.io/src/images/gcp.png")}/>
        <CardMobile title="Lead at DSC BVP" date="Aug. 2020​ to Aug. 2021" text={[`Worked as a community manager on campus chosen via Google Developer Student Clubs.`,`Organized 15 + workshops with hands-on sessions on software and hardware fundamentals.`]} src={require("/home/himandri/Dev/reactfol/himandrisharma.github.io/src/images/dsc.png")}/>
