  ...
  return (
    <>
      <div className="ExperienceStyle">
        <div className="ExperienceNavbar"><a className="navIcon" href="https://drive.google.com/file/d/1dCDo0LqkU6jgN4XOwzLP_nNgKsgkjMxJ/view?usp=sharing"  >Resume</a>&nbsp;&nbsp;&nbsp;<Link className="navIcon" to="/"  >Home</Link>&nbsp;&nbsp;&nbsp;<Link className="navIcon" to="/contact"  >Contact</Link> </div>
