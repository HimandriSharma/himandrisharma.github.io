  ...
  return (
    <>
      <div className="ExperienceStyle">
        <div className="ExperienceNavbar"><a className="navIcon" href="https://drive.google.com/file/d/1IAx083dfo7P2Jh1vFX8uFze-DBVhVhFE/view?usp=sharing"  >Resume</a>&nbsp;&nbsp;&nbsp;<Link className="navIcon" to="/"  >Home</Link>&nbsp;&nbsp;&nbsp;<Link className="navIcon" to="/Socials"  >Socials</Link> </div>
