  ...
  return (
    <>
      <div className="ExperienceStyle">
        <div className="ExperienceNavbar"><a className="navIcon" href="https://drive.google.com/file/d/1dCDo0LqkU6jgN4XOwzLP_nNgKsgkjMxJ/view?usp=sharing" style={{textDecoration:"none"}}>Resume</a>&nbsp;&nbsp;&nbsp;<Link className="navIcon" to="/" style={{textDecoration:"none"}}>Home</Link>&nbsp;&nbsp;&nbsp;<Link className="navIcon" to="/contact" style={{textDecoration:"none"}}>Contact</Link> </div>
        ...
        <CardDesktop title="Google Cloud Facilitator" date="· Sept. 2020​ to Nov. 2020​​" text={[`Got trained under Developer Student Clubs(Powered by Google Developers) and Qwiklabs.`,`Organized 5+ Cloud workshops and gave hands-on with Google Cloud Platform.`]} src={require("/home/himandri/Dev/reactfol/webme/src/images/gcp.png")}/>
        <CardDesktop title="Lead at DSC BVP" date="Aug. 2020​ to Aug. 2021" text={[`Worked as a community manager on campus chosen via Google Developer Student Clubs.`,`Organized 15 + workshops with hands-on sessions on software and hardware fundamentals.`]} src={require("/home/himandri/Dev/reactfol/webme/src/images/dsc.png")}/>
