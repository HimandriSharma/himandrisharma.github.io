    ...
    <div className="ContactStyle">
      ...
      <div className="Text">
        ...
        <div className="ContactParaText">
          ...
          <div className="ContactAlign"><img src={GmailLogo} alt="" style={{height:"5vmin",margin:"10px"}}/><a href="mailto:himandrisharma27@gmail.com" style={{padding:"10px",textDecoration:"none",color:"black"}}>himandrisharma27@gmail.com</a></div>
        </div>
      </div>
    </div>
  );
