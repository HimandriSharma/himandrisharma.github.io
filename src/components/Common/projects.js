    ...
    <div className="ProjectsStyle">
      <div className="ProjectsContent">
        ...
        <div className="ProjectsSpecific">
          ...
          <CardProject title="InstaDoge" stacks="ReactJS" text={["A ReactJS website to scroll through dog images for fun.","Integrated API using Axios to fetch images.","Responsive gallery look using CSS."]} link="/"/>
