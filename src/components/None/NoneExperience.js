  ...
  return (
    <>
      <div className="NoneExperienceStyle">
        <div className="NoneNavbar"><a className="navIcon" href="https://drive.google.com/file/d/1dCDo0LqkU6jgN4XOwzLP_nNgKsgkjMxJ/view?usp=sharing" style={{textDecoration:"none"}}>Resume</a>&nbsp;&nbsp;&nbsp;<Link className="navIcon" to="/" style={{textDecoration:"none"}}>Home</Link>&nbsp;&nbsp;&nbsp;<Link className="navIcon" to="/" style={{textDecoration:"none"}}>Contact</Link> </div>
